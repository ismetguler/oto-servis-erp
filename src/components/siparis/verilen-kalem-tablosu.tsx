...
import {
  ...
  katalogAraAction,
  type KalemDurumu,
} from "@/app/(panel)/siparis/verilen/actions"
...
/**
 * VERİLEN SİPARİŞ KALEMLERİ — `SiparisKalemTablosu`nun (alınan sipariş)
 * aynası, `verilen/actions`e bağlı; arama kutusu alış fiyatını önerir
 * (`verilen/veri.ts`teki `katalogAra` → `katalogAraAlis`).
 */
...
export function VerilenKalemTablosu({
  siparisId,
  kalemler,
  duzenlenebilir,
}: {
