...
import { siparisKaydet, type SiparisFormDurumu } from "@/app/(panel)/siparis/verilen/actions"
import type { SiparisCarisi } from "@/app/(panel)/siparis/verilen/veri"
...
/**
 * VERİLEN SİPARİŞ KARTI — üst bilgi formu. `SiparisFormu`nun (alınan sipariş)
 * aynası; tek fark cari alanının etiketi "Tedarikçi".
 */
export function VerilenFormu({
  baslangic,
  cariler,
}: {
  baslangic?: {
