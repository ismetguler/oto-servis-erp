...
/**
 * VERİLEN SİPARİŞ — doğrulama kuralları
 *
 * Alınan siparişin (`siparis/alinan/sema.ts`) aynası; tek fark cariId
 * alanının etiketi (form tarafında "Tedarikçi") — veri tipi/kural aynı.
 */
