...
export const metadata: Metadata = { title: "Tahsilat Girişi" }
export const dynamic = "force-dynamic"

export default async function TahsilatGirisi({
  searchParams,
}: {
    ...
    <div className="flex flex-col">
      <div className="sayfa-basligi">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-[1.0625rem] font-semibold tracking-tight">Tahsilat Girişi</h1>
            <p className="text-[0.8125rem] text-muted-foreground">
              Müşteriden alınan para — cari borcu azalır, kasaya giriş düşer
            </p>
          </div>
        </div>
      </div>

      <TahsilatFormu tur="TAHSILAT" kasalar={kasalar} hazirCari={hazirCari} />
    </div>
  )
}
